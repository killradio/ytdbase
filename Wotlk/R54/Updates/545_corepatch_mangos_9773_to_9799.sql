...
# SD2_1679
UPDATE creature_template SET ScriptName='' WHERE entry=25059;
UPDATE creature_template SET ScriptName='' WHERE entry=25236;
UPDATE creature_template SET ScriptName='' WHERE entry IN (27274, 27275);
