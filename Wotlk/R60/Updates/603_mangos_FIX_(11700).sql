# Y2kCat
ALTER TABLE db_version_ytdb CHANGE COLUMN 602_FIX_11630 603_FIX_11700 bit;
REPLACE INTO `db_version_ytdb` (`version`) VALUES ('603_FIX_11700');

# Fix
# UPDATE `quest_template` SET `SpecialFlags` = 0 WHERE `entry` = 10162;

# NeatElves
DELETE FROM `game_event_creature_data` WHERE `guid` in (4861,5599,5758,5764,5774,5922,5961,5980,5992,5997,6001,6006,6034,6054,6084,6087,6097,6099,6116,6119,6139,6142,6285,6291,6296,6314,6324,6368,6443,53583,53584,127279,127281);
UPDATE  `quest_template` SET  `RequiredSkill` =  '0',`RequiredSkillValue` =  '0' WHERE  `entry` in (7892,7891,7889,7893,7890,7939);
UPDATE  `quest_template` SET  `RequiredSkill` =  '0',`RequiredSkillValue` =  '0' WHERE  `entry` in (7897,7896,7894,7942,7898,7895);
UPDATE  `quest_template` SET  `RequiredSkill` =  '0',`RequiredSkillValue` =  '0' WHERE  `entry` in (7883,7941,7882,7884,7885,7881);
...
REPLACE INTO `gossip_menu_option` (`menu_id`,`id`,`option_icon`,`option_text`,`option_id`,`npc_option_npcflag`,`action_menu_id`,`action_poi_id`,`action_script_id`,`box_coded`,`box_money`,`box_text`) VALUES (8081,0,0, 'Magistrix Carinda has sent me to ask you about Arelion''s secret.  Who was he seeing?',1,1,0,0,0,0,0, '');
UPDATE `gossip_menu_option` SET `cond_1` = '9',`cond_1_val_1` = '10286' WHERE `menu_id` =8081 AND `id` =0;
...
UPDATE `gossip_menu_option` SET `cond_1` = '9',`cond_1_val_1` = '10162' WHERE `menu_id` =7967 AND `id` =0;
UPDATE `gossip_menu_option` SET `cond_1` = '9',`cond_1_val_1` = '10347' WHERE `menu_id` =7967 AND `id` =1;
UPDATE `gossip_menu_option` SET `cond_1` = '9',`cond_1_val_1` = '10242' WHERE `menu_id` =7967 AND `id` =4;
UPDATE `gossip_menu_option` SET `cond_1` = '9',`cond_1_val_1` = '10129' WHERE `menu_id` =7967 AND `id` =5;
UPDATE `gossip_menu_option` SET `action_menu_id` = '-1',`action_script_id` = '7967' WHERE `menu_id` =7967 AND `id` =0;
UPDATE `gossip_menu_option` SET `action_menu_id` = '-1',`action_script_id` = '7967' WHERE `menu_id` =7967 AND `id` =1;
DELETE FROM `gossip_scripts` WHERE `id` = 7967;
...
UPDATE `gossip_menu_option` SET `action_menu_id` = '-1',`action_script_id` = '5' WHERE `menu_id` =7967 AND `id` =4;
UPDATE `gossip_menu_option` SET `action_menu_id` = '-1',`action_script_id` = '6' WHERE `menu_id` =7967 AND `id` =5;
DELETE FROM `gossip_scripts` WHERE `id` = 5;
DELETE FROM `gossip_scripts` WHERE `id` = 6;
INSERT INTO `gossip_scripts` (`id`, `delay`, `command`, `datalong`, `datalong2`, `datalong3`, `datalong4`, `data_flags`, `dataint`, `dataint2`, `dataint3`, `dataint4`, `x`, `y`, `z`, `o`, `comments`) VALUES
...
REPLACE INTO `gossip_menu` (`entry`, `text_id`, `cond_1`, `cond_1_val_1`, `cond_1_val_2`, `cond_2`, `cond_2_val_1`, `cond_2_val_2`) VALUES ('7953', '10109', '8', '10162', '0', '0', '0', '0');
DELETE FROM `npc_gossip` WHERE `npc_guid` = 59687;
DELETE FROM `npc_gossip` WHERE `npc_guid` = 59686;
DELETE FROM `npc_gossip` WHERE `npc_guid` = 58812;
DELETE FROM `npc_gossip` WHERE `npc_guid` = 59563;
...
REPLACE INTO `creature_template_addon` (`entry`, `mount`, `bytes1`, `b2_0_sheath`, `b2_1_pvp_state`, `emote`, `moveflags`, `auras`) VALUES ('20159', '19479', '0', '1', '0', '0', '0', NULL);
...
INSERT IGNORE INTO `item_expire_convert` VALUES (44632, 44626), (44626, 44629);
INSERT IGNORE INTO `item_expire_convert` VALUES (39878, 39883), (44717, 44718);
REPLACE INTO `creature_template_addon` (`entry`, `mount`, `bytes1`, `b2_0_sheath`, `b2_1_pvp_state`, `emote`, `moveflags`, `auras`) VALUES ('21250', '0', '0', '1', '0', '0', '0', '36440');
DELETE FROM `creature_template_addon` WHERE `entry` = 6271;
DELETE FROM `spell_script_target` WHERE `entry` IN (62521, 62524, 62525);
...
REPLACE INTO `game_event_gameobject` (`guid`, `event`) VALUES ('5688', '1'), ('5718', '1'), ('5727', '1'), ('5730', '1'), ('5731', '1'), ('5732', '1');
REPLACE INTO `creature` (`guid`, `id`, `map`, `spawnMask`, `phaseMask`, `modelid`, `equipment_id`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecs`, `spawndist`, `currentwaypoint`, `curhealth`, `curmana`, `DeathState`, `MovementType`) VALUES
(49057, 16781, 530, 1, 1, 0, 0, 2274.78, 6104.63, 138.362, 2.14532, 300, 0, 0, 7400, 0, 0, 0),
(49064, 16781, 530, 1, 1, 0, 0, 2274.24, 6110.48, 138.209, 4.75284, 300, 0, 0, 8700, 0, 0, 0),
(53435, 26401, 530, 1, 1, 0, 0, 2288.28, 6128.06, 135.699, 2.11861, 300, 0, 0, 42, 0, 0, 0),
(53436, 16781, 530, 1, 1, 0, 0, 2307.35, 6130.41, 134.915, 3.11764, 300, 0, 0, 7400, 0, 0, 0),
(60593, 16781, 530, 1, 1, 0, 0, 2300.35, 6130.58, 135.505, 6.08959, 300, 0, 0, 8700, 0, 0, 0);
REPLACE INTO `game_event_creature` (`guid`, `event`) VALUES ('49057', '1'), ('49064', '1'), ('53435', '1'), ('53436', '1'), ('60593', '1');
...
REPLACE INTO `achievement_criteria_requirement` (`criteria_id`, `type`, `value1`, `value2`) VALUES ('6804', '5', '58933', '0');
...
REPLACE INTO `gossip_menu_option` (`menu_id`, `id`, `option_icon`, `option_text`, `option_id`, `npc_option_npcflag`, `action_menu_id`, `action_poi_id`, `action_script_id`, `box_coded`, `box_money`, `box_text`, `cond_1`, `cond_1_val_1`, `cond_1_val_2`, `cond_2`, `cond_2_val_1`, `cond_2_val_2`, `cond_3`, `cond_3_val_1`, `cond_3_val_2`) VALUES ('9203', '0', '0', 'Loremaster Festival asked me to talk to you.', '1', '1', '9282', '0', '0', '0', '0', NULL, '0', '0', '0', '0', '0', '0', '0', '0', '0');
...
UPDATE `creature_template` SET vehicle_id=220, Spell1=56091, Spell2=56092, Spell3=57090, Spell4=57143 WHERE entry IN (30161, 31752);
UPDATE `achievement_criteria_requirement` SET `type` = '5',`value1` = '55817' WHERE `criteria_id` =7136 AND `type` =18;
UPDATE `achievement_criteria_requirement` SET `type` = '5',`value1` = '58501' WHERE `criteria_id` IN (10088,10089,10418,10419,10420,10421) AND `type` =18;
...
UPDATE `creature_template` SET `minlevel`=75,`maxlevel`=75,`baseattacktime`=2000,`speed_run`=3.42857,`Vehicle_Id`=107 WHERE `entry`=35299;
...
UPDATE `creature_template` SET `faction_A`=35,`faction_H`=35,`baseattacktime`=2000,`unit_flags`=0x4000,`speed_run`=1,`Vehicle_Id`=510 WHERE `entry`=34944; -- Keep Cannon (faction is set by core script A: 1732, H: 1735)
...
UPDATE `creature_template` SET `baseattacktime`=2000,`unit_flags`=0x2004000,`unit_class`=4,`speed_walk`=1.2,`Vehicle_Id`=436 WHERE `entry`=36355; -- Siege Turret
...
UPDATE db_version SET `cache_id`= '603';
UPDATE db_version SET `version`= 'YTDB_0.14.3_R603_MaNGOS_R11700_SD2_R2233_ACID_R308_RuDB_R39';
