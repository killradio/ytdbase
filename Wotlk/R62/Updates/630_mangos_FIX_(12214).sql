# Y2kCat
ALTER TABLE db_version_ytdb CHANGE COLUMN 629_FIX_12178 630_FIX_12214 bit;
REPLACE INTO `db_version_ytdb` (`version`) VALUES ('630_FIX_12214');
...
UPDATE db_version SET `cache_id`= '630';
UPDATE db_version SET `version`= 'YTDB_0.14.6_R630_MaNGOS_R12214_SD2_R2737_ACID_R310_RuDB_R56';
